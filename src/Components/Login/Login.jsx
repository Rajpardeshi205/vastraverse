...
const Login = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center mt-10 ">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center text-gray-600 cursor-pointer hover:text-gray-800 transition-colors">
                <input
                  type="checkbox"
                  className="mr-2 w-4 h-4 text-blue-600 bg-gray-50 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"
                />
                Remember me
              </label>
              <button className="text-blue-600 hover:text-blue-700 transition-colors hover:underline font-medium">
                Forgot password?
              </button>
            </div>
